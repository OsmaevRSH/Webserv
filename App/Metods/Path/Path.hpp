...
class Path
{
	protected:
		...
		void setup_global_params(t_params &global_params, ConfigParser::t_server &server, bool save_server);
		bool check_allow_metods(const t_params &param, Parse_input_handler &handlers);
		template<class T>

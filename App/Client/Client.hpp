...
class Client
{
	public:
		...
		Client()
				: _client_handler(nullptr), _content_length_buffer(0), _chunked_length(0), _chunked_length_status(false), _client_fd(0),
				_curent_progress(0), _answer_is_ready(false), _chunked_end_check_status(false) {}
